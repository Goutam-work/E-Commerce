    ...
    <div class="modal-content">
      ...
      <div class="modal-body" id="scrollable">
        <form name="registration" id="registrationForm" method="POST">
          ...
          <button type="button" class="btn btn-default btn-success btn-block" onClick="return validateForm();">
  ...
  <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form name="loginform">
            <div class="form-group">
              <label for="usrname"><span class="glyphicon glyphicon-user"></span> Username</label><span class="errormessage">*hello</span>
